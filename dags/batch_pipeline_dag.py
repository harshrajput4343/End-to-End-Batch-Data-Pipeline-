...
with DAG(
    ...
    description='End-to-end batch pipeline: Ingest -> Load -> dbt',
    ...
    # Task 2: Load Cleaned CSV to AWS (S3 -> Redshift)
    load_to_aws_task = BashOperator(
        task_id='load_to_aws_task',
        bash_command=f'python {os.path.join(PROJECT_ROOT, "etl", "load_to_aws.py")}',
    )
    ...
    # Define Dependencies
    ingest_data_task >> load_to_aws_task >> run_dbt_models_task
